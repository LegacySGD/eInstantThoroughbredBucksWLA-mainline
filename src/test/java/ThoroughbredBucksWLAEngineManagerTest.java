...
public class ThoroughbredBucksWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ThoroughbredBucksWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ThoroughbredBucksWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ThoroughbredBucksWLAIW/InitOutcome.xml").getDocumentElement();
